...
if __name__ == '__main__':
    ...
    It needs to be called from the top directory of the repository
    e.g. specfem2d.
    This directory needs to contain the EXAMPLES directory.
    The environment variables needed to compile the code are given
    in a module called env_config.py.
    ...
    Args:
      code_name: The name of the code used: specfem2d, specfem3d,
                 specfem3d_globe
      ...
      ref_top_dir: The top directory where the reference seismograms
                   are stored.
    ...
    Assumptions:
      ...
      The execution directory is the top level of the repo.
      e.g. specfem2d, where
